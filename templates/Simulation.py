...
# %%
# Fire dates
fire_start_date = '2019-01-15'
fire_end_date = '2019-03-07'

# Recovery settings
recovery_times = [0, 0.5, 1, 1.5, 2, 2.5]
recovery_interval_years = 0.5

# Rainfall simulation period
rain_data_start = fire_end_date
rain_data_end = '2022-03-07'
...
# %%
catchment_results = results[0][catchment_name] # or catchment_results = results[0.5][catchment_name]
